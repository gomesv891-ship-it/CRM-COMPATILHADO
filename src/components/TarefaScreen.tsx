...
export const TarefaScreen: React.FC<TarefaScreenProps> = ({
  ...
  }, [tasks, isDirector, currentUserName]);
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="h-10 px-5 rounded-xl bg-[#0057ff] hover:bg-blue-700 text-white font-bold text-xs sm:text-sm flex items-center gap-2 shadow-sm transition-all cursor-pointer self-start sm:self-center"
          >
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 text-right whitespace-nowrap">
                        <div className="inline-flex items-center gap-1">
                          ...
                          {/* Menu Três Pontinhos */}
                          <div className="relative inline-block text-left" ref={openActionMenuId === task.id ? actionMenuRef : null}>
                            <button
                              type="button"
                              onClick={() =>
                            ...
                            {openActionMenuId === task.id && (
                              <div className="absolute right-0 top-8 z-20 w-44 bg-white rounded-xl border border-slate-200 shadow-xl py-1 text-left animate-in fade-in duration-100">
                                <button
                                  type="button"
                                  onClick={() => handleToggleTaskStatus(task)}
                                ...
                                <button
                                  ...
                                  className="w-full px-3 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 flex items-center gap-2 cursor-pointer"
                                >
                                  <Trash2 className="w-3.5 h-3.5" />
                                  <span>Excluir</span>
                                </button>
