  ...
  return (
    ...
    >
      ...
      <div className="p-5 space-y-4 bg-white">
        ...
        {/* ======================================================== */}
        {/* DESCONTO COMERCIAL (SOMENTE SE HOUVER DESCONTO APLICADO) */}
        {/* ======================================================== */}
        {descontoValor && descontoValor > 0 ? (
          <div className="rounded-xl overflow-hidden border border-emerald-200 bg-emerald-50/90 py-2.5 px-5 flex items-center justify-between shadow-2xs">
            <div className="flex items-center gap-2 text-emerald-800 font-bold text-[13px] uppercase tracking-wider">
        ...
        <div className="rounded-xl overflow-hidden border border-[#cde2f0] flex items-stretch bg-white shadow-2xs">
          ...
          <div className="w-[300px] bg-[#003865] text-white py-3.5 px-6 flex items-center justify-center flex-shrink-0">
            <span className="text-[26px] sm:text-[28px] font-black tracking-tight text-white leading-none">
