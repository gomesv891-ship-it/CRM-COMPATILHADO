...
export interface ResponsibleFilterTabsProps {
  activeTab: string; // 'Todos' | 'Éder' | 'Vanessa' | 'Jhessica' | 'Demais usuários' | string
...
export const ResponsibleFilterTabs: React.FC<ResponsibleFilterTabsProps> = ({
  ...
  const baseTabs = [
    ...
    { id: 'Éder', label: 'Éder', userName: 'Éder Perez', isAll: false, countKey: 'eder' },
    { id: 'Vanessa', label: 'Vanessa', userName: 'Vanessa Gomes', isAll: false, countKey: 'vanessa' },
    { id: 'Jhessica', label: 'Jhessica', userName: 'Jhessica Camargo', isAll: false, countKey: 'jhessica' },
  ];
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto pb-1 sm:pb-0 scrollbar-none">
        {baseTabs.map((tab) => {
          const isActive =
            ...
            (tab.id === 'Éder' && (activeTab === 'Eder' || activeTab.toLowerCase().includes('eder')));
